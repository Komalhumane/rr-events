            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group pl-15 pr-15">
                        ...
                        <div class="col-sm-4 file-top">
                            <input type="file" name="data[photo][photo_1]" id="photo_1" tabindex ='14' title="Upload a Photo Max. 2MB (optional)">
                ...
                <div class="col-sm-6">
                    ...
                    <?php 
                        ...
                        <a id="photo_1_remove" <?php echo $display; ?> >Remove Image
                            ...
                            <a href="<?php echo $image; ?>" <?php echo $display; ?> id="photo_1_link" class="test-popup-link thumbnail">

                              <img id="photo_1_display" src="<?php echo $image; ?>" alt="...">
                            </a>
                        </div>                                    
                </div>
            </div>
